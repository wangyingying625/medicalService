...
Route::any('temp','Wechat\TemplateController@uploadTmp');
Route::any('temp/create','Wechat\TemplateController@createTemplate');
Route::get('temp/list','Wechat\TemplateController@getTemplateByOpenId');
Route::get('temp/info','Wechat\TemplateController@showTemplateByName');
Route::get('temp/delete','Wechat\TemplateController@deleteTemplate');
Route::any('tempocr','Wechat\TemplateController@OCR');
