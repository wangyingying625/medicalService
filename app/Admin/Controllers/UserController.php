...
class UserController extends Controller
{
    ...
    protected function form()
    {
        ...
        $form->text('name', 'Name');
        $form->image('avatar', 'Avatar')->default('/img/default.jpg');
        $form->text('sex', 'Sex');
        $form->date('birthday', 'Birthday')->default(date('Y-m-d'));
        $form->decimal('height', 'Height');
        $form->decimal('weight', 'Weight');
        $form->number('family_id', 'Family id');
        $form->text('status', 'Status')->default('no');
